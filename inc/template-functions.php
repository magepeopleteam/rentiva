...
function rentiva_get_demo_rentals() {
	return array(
		...
		array(
			'id'         => 0,
			'title'      => __( 'City Glide E-Scooter', 'rentiva' ),
			'type'       => __( 'Electric Scooter', 'rentiva' ),
			'url'        => rentiva_get_rentals_page_url(),
			'image_id'   => 0,
			'rating'     => 4.7,
			'reviews'    => 41,
			'location'   => __( 'Dhaka', 'rentiva' ),
			'price'      => rentiva_format_price( 12 ),
			'price_unit' => __( '/ day', 'rentiva' ),
		),
		array(
			'id'         => 0,
			'title'      => __( 'Capture Pro DSLR Kit', 'rentiva' ),
			'type'       => __( 'DSLR Camera', 'rentiva' ),
			'url'        => rentiva_get_rentals_page_url(),
			'image_id'   => 0,
			'rating'     => 4.9,
			'reviews'    => 76,
			'location'   => __( 'Chittagong', 'rentiva' ),
			'price'      => rentiva_format_price( 30 ),
			'price_unit' => __( '/ day', 'rentiva' ),
		),
		array(
			'id'         => 0,
			'title'      => __( 'Alpine 2-Person Tent', 'rentiva' ),
			'type'       => __( 'Dome Tent', 'rentiva' ),
			'url'        => rentiva_get_rentals_page_url(),
			'image_id'   => 0,
			'rating'     => 4.8,
			'reviews'    => 38,
			'location'   => __( 'Sylhet', 'rentiva' ),
			'price'      => rentiva_format_price( 15 ),
			'price_unit' => __( '/ day', 'rentiva' ),
		),
		array(
			'id'         => 0,
			'title'      => __( 'Sunset Paddleboard Duo', 'rentiva' ),
			'type'       => __( 'Inflatable SUP (Pair)', 'rentiva' ),
			'url'        => rentiva_get_rentals_page_url(),
			'image_id'   => 0,
			'rating'     => 4.9,
			'reviews'    => 29,
			'location'   => __( 'Chittagong', 'rentiva' ),
			'price'      => rentiva_format_price( 20 ),
			'price_unit' => __( '/ day', 'rentiva' ),
		),
	);
}
